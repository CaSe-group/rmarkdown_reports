...
#if (is.null(PROKKA_INPUT_FILE) || PROKKA_INPUT_FILE == "#RESULTSENV#"){
#print("No source file detected please specify PROKKA input file")
#  EXIT <- TRUE
#}
#
# Check if gff3
#if (ncol(PROKKA_RAW) != 9 || str_detect(PROKKA_INPUT_FILE, "gff", negate = TRUE)){
...
Prokka version used: #VERSIONENV#  
