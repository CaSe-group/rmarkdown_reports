...
`r if(METAGENOMIC_DATA_NOT_EMPTY & GREP_F_MATCH) {
	sprintf("Probability for this organism is **%s** (Score is from 0 to 1; 1 means exact match).\n", F_MATCH_VALUE)
} else if (METAGENOMIC_DATA_NOT_EMPTY & !GREP_F_MATCH) {
...
} else if (!METAGENOMIC_DATA_NOT_EMPTY) {
