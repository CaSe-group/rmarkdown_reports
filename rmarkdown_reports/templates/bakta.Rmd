...
Bacterial species can contain up to 15 rRNA operons [(Klappenbach et al.)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC91988/#B28) each containing three RNA genes: 5S, 16S and 23S in a close proximity. 

Bakta detected `r ARNA` 5S, `r BRNA` 16S and `r CRNA` 23S  rRNA genes (would correspond to ~`r as.integer((ARNA+BRNA+CRNA)/3)` operons)<span style="color:red; font-weight: bold">`r if (((ARNA+BRNA+CRNA)/3)>15){
...
}`</span>. You can check their close proximity via Table 3 (search "ribosomal RNA"). If you have more RNA operons than expected please check quality of the data and the Sourmash tab for contaminations.
