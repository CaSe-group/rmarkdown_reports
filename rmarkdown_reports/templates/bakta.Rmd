...
BAKTA_RAW <- suppressMessages(read_delim(BAKTA_INPUT_FILE, 
...
#### Overview
Bakta founded **`r GEN_N` features** located on **`r CONTIG_N` contigs**  (see Fig.2) and **`r TRNA_N_GEN` tRNA** sequences.
...
```{r}
col_pallet<- c("#BEAED4","#FDC086","#FFFF99","#386CB0","#F0027F","#BF5B17","#666666","#A6CEE3","#1F78B4","#B2DF8A","#33A02C","#FB9A99","#E31A1C")
#margins
M <- list(
          l = 50,
          r = 50,
