...
Bacterial species can contain up to 15 rRNA operons each containing the threes RNA genes 5S, 16S and 23S in close proximity. 
...
}`</span>. You can check their close proximity via Table 3 (search "ribosomal RNA"). If you have more 16S RNA than expected please check quality of your data and Sourmash tab for contaminations.
